...
While G<sup>2</sup>RINS is under development, you can explore the related G-BigSMILES repositories here:

- Latest G-BigSMILES repository: [https://github.com/gervasiozaldivar/G-BigSMILES](https://github.com/gervasiozaldivar/G-BigSMILES)
- Previous G-BigSMILES repository: [https://github.com/InnocentBug/G-BigSMILES](https://github.com/InnocentBug/G-BigSMILES)
